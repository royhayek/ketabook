...
import 'package:ketabook/screens/majors_screen/majors_screen.dart';
...
class FacultyListItem extends StatelessWidget {
  ...
  const FacultyListItem({Key key, this.faculty, this.major}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () => Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => major != null
              ? BooksScreen(implyLeading: true, major: major)
              : MajorsScreen(faculty: faculty),
        ),
      ),
      child: Container(
                ...
                children: [
                  Container(
                    ...
                    child: Card(
                      ...
                      child: Image.network(
                        '${WebService.getImageUrl()}${major != null ? major.photo : faculty.photo}',
